...
//     if(event.target.classList.contains('list-layout')){
...
//     }else if(event.target.classList.contains('grid-layout')){
...
//         document.querySelector('#container').classList.remove('list-layout');
